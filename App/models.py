...
class Property(models.Model):
    ...
    first_floor = models.ImageField(blank=True, null=True)
    first_floor_description = models.TextField(blank=True, null=True)
    second_floor = models.ImageField(blank=True, null=True)
    second_floor_description = models.TextField(blank=True, null=True)
    third_floor = models.ImageField(blank=True, null=True)
